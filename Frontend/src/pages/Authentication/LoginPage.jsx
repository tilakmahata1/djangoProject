        ...
        <form className="max-w-md md:ml-auto w-full" onSubmit={handlesubmit}>
          ...
          <div className="space-y-6">
            <div>
              ...
              <input name="email" type="email" value={email}  required className="bg-slate-100 w-full text-sm text-slate-800 px-4 py-3 rounded-md outline-0 border border-gray-200 focus:border-blue-600 focus:bg-transparent" placeholder="Enter Email" onChange={(e) => setEmail(e.target.value)} />
            </div>
            <div>
              <label className='text-sm text-slate-800 font-medium mb-2 block'>Password</label>
              <input name="password" type="password" value={password} required className="bg-slate-100 w-full text-sm text-slate-800 px-4 py-3 rounded-md outline-0 border border-gray-200 focus:border-blue-600 focus:bg-transparent" placeholder="Enter Password" onChange={(e) => setPassword(e.target.value)} />
            </div>
          ...
          <div className="!mt-12">
            <button type="button" className="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-red-500 bg-blue-600 hover:bg-blue-700 focus:outline-none cursor-pointer" onClick={handlesubmit}>
              Log in
            </button>
          </div>
